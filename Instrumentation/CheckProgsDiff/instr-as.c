...
void addToAllFiles(FILE *file, FILE *file2, char *lines){
  ...
  addToOutFile(file, lines, block_id); // test file so we can see what we are doing and changing
  addToOutFile(file2, lines, block_id); // this one is the one that instrumentalizes
